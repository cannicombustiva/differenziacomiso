import type { WasteType, CollectionDayGrouped, RiciclabolarioItem, Announcement } from '@differenzia/core/types';
import { format, addDays } from 'date-fns';
import { settimanaTipo } from '@differenzia/core/settimana-tipo';
